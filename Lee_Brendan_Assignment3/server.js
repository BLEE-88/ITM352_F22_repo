// Brendan Lee 12/14/2022 This is my server page and the variuous vars are used to communicate that we need those node installations
//I generated my login, registration, and cart on the server to avoid having to use LoadJSON because the information would be sent from the server to the server.
//The app gets and posts are used to communicate with the HTML pages.
