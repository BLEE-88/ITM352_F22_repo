...
<script> //Functions to loadJSON and to assign the action to a button https://stackoverflow.com/questions/2701041/how-can-i-set-the-form-action-through-javascript
    ...
    <div class="topnav">
      ...
      <table class = "center" border="2">
        <tbody>
          ...
          {
            type = get_typeof(i); //Received help from Bobby for this part
            ...
            for (var j = 0; j<products_data[type].length; j++) { //If quantity entered is equal to 0 continue
                if (shopping_cart[type][j] == 0) {
                    ...
                    onkeyup="invalidqty(this.value, '${request.session.cart[type][j]}', '${type}', ${j})" placeholder=0 min=0 max=${products_data[type][j].qtyavl}
                    </td>
...
app.get('/checkout', function (request, response) {
  ...
  var invoice_str = `Thank you for your order! ${user_email} <table border>
  <tr>
  <th style="text-align: center;" width="16%">Product</th>
  <th style="text-align: center;" width="13%">Price</th>
  <th style="text-align: center;" width="25%">Quantity</th>
