...
app.get("/add_to_cart", function (request, response) {
    ...
    var quantity = request.query['quantity'].map(Number); // Get quantities from the form post and convert strings from form post to numbers
    request.session.cart[products_key] = quantity; // store the quantities array in the session cart object with the same products_key. 
